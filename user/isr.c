...
//    imu660ra_data_get();
    ...
    if(angle_Integral_start_flag==1)
        {
//        yaw_yuan=eulerAngle.yaw;
            angle_Integral_finish_flag=angle_Integral(360);
            if(angle_Integral_finish_flag==1)
            {
                angle_Integral_start_flag=0;
            }
        }
//    yaw=yaw_yuan-eulerAngle.yaw;
//    if(yaw<0)yaw+=180;
    yaw_amend(20,30);
}

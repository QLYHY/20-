...
float yaw_g,roll_a,roll_g,pitch_a,pitch_g;//yaw_last=0;
...
// 参数说明     void
// 返回参数     void
// 使用示例     mpu6050_real_data_get();
// 备注信息
//-------------------------------------------------------------------------------------------------------------------


void mpu6050_real_data_get(void)
{
    mpu6050_get_gyro();
    mpu6050_get_acc();

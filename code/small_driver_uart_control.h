...
extern float count_left,count_right;

extern int encoder_start_flag,encoder_finish_flag;

extern float journey_left,journey_right,journey;

extern float left_speed_data,right_speed_data;
